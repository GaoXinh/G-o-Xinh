...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Nhịp đập trái tim " + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-body').innerHTML = 'Say ánh mắt nụ cười của ai đó -.- <i class="fas fa-heart"></i> ';
